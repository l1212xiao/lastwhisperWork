...
public class DbPasswordDec {
	public static void main(String[] args) {
		String key1 = "c";
		String key2 = "t";
		String key3 = "j";
		String data = "CTJtest!123";  // 需要加解密密的原始密码
		...
		if (leng > 0) {
			if (leng < 4) {
				...
				if (firstKey != null && !"".equals(firstKey) && secondKey != null && !"".equals(secondKey) && thirdKey != null && !"".equals(thirdKey)) {
					...
					encByte = tempBt;
				} else if (firstKey != null && !"".equals(firstKey) && secondKey != null && !"".equals(secondKey)) {
					int[] tempBt = bt;
					for (int x = 0; x < firstLength; x++) {
						tempBt = enc(tempBt, firstKeyBt.get(x));
					}
					...
					encByte = tempBt;
				} else if (firstKey != null && !"".equals(firstKey)) {
					int x = 0;
					int[] tempBt = bt;
